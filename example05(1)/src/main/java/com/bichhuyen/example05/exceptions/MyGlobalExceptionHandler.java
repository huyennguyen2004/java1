package com.bichhuyen.example05.exceptions;
...
import com.bichhuyen.example05.payloads.APIResponse;
...
public class MyGlobalExceptionHandler {
  ...
  public ResponseEntity<Map<String, String>>
      ...
      myConstraintsVoilationException(ConstraintViolationException e) {
    Map<String, String> res = new HashMap<>();
