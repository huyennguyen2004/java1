...
export const dataProvider: DataProvider = {
  getList: async (
    ...
    console.log("Useremail", localStorage.getItem("username"));
    ...
    return await httpClient.get(url).then(({ json }) => {
      ...
      console.log("data list: ", data); // hiện dữ liệu product
